class LFUCache {
    ...
    class DoubleLinkedList {
        ...
        public void remove(DLLNode currNode) { // Corrected parameter reference
            DLLNode prevNode = currNode.prev; // Updated to currNode
            DLLNode nextNode = currNode.next; // Updated to currNode
